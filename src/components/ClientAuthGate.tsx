...
export const ClientAuthGate: React.FC<ClientAuthGateProps> = ({
  ...
  const [step, setStep] = useState<'welcome' | 'complete_profile'>(
    'welcome'
  );
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (needsProfileCompletion) {
        ...
        // Usuário já possui cadastro completo
      ...
      if (err?.code === 'auth/popup-closed-by-user') {
        ...
        // Ignora quando o usuário clica várias vezes
              ...
              {loading ? (
                ...
                <>
                  ...
                  >
                    ...
                    <path
                      fill="#FBBC05"
                      d="M5.28 14.27c-.25-.72-.38-1.49-.38-2.27s.13-1.55.38-2.27V6.58H1.25C.45 8.18 0 9.99 1.25 5.42l4.03-3.15z"
                    />
