...
export const ClientAuthGate: React.FC<ClientAuthGateProps> = ({
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err?.code === 'auth/popup-closed-by-user') {
        ...
        setErrorMsg(
          'A janela de login com o Google foi fechada antes de concluir.'
        );

      } else if (err?.code === 'auth/popup-blocked') {

        setErrorMsg(
          'A janela popup foi bloqueada pelo navegador. Permita popups para este site e tente novamente.'
        );
        ...
        setErrorMsg(
          'Falha de conexão com a internet. Verifique sua rede e tente novamente.'
        );
  ...
  const handleCompleteProfileSubmit = async (
    ...
    if (!validateBrazilianPhone(phone)) {
      ...
      setErrorMsg(
        'Por favor, informe um número de celular válido com DDD (ex: (11) 98765-4321).'
      );
    ...
    if (!authenticatedUser) {
      ...
      setErrorMsg(
        'Sessão expirada. Por favor, faça login com o Google novamente.'
      );
    ...
    try {
      ...
      console.error(
        'Error saving client profile:',
        err
      );

      setErrorMsg(
        'Falha ao salvar seus dados. Verifique a conexão e tente novamente.'
      );
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-[#FAF3F5] via-[#FCF9F7] to-[#F5EBEF] flex flex-col justify-between items-center px-4 py-8 sm:py-12 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl sm:rounded-4xl border border-[#EFE2E7] shadow-xl p-6 sm:p-8 space-y-6 my-6 z-10 transition-all">
        ...
        <div className="text-center space-y-1.5">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FAF0F3] text-[#9E4760] text-xs font-semibold">
            ...
            <Heart
              className="w-3.5 h-3.5 fill-[#9E4760]"
            />
        ...
        {step === 'welcome' && (
          ...
          <div className="space-y-4 pt-1">
              ...
              {loading ? (
                ...
                <>
                  ...
                  >
                    ...
                    <path
                      fill="#FBBC05"
                      d="M5.28 14.27c-.25-.72-.38-1.49-.38-2.27s.13-1.55.38-2.27V6.58H1.25C.45 8.18 0 9.99 1.25 12s.45 3.82 1.25 5.42l4.03-3.15z"
                    />
            ...
            <p className="text-[11px] text-[#8E6A77] text-center leading-relaxed px-2">
              ...
              Sem necessidade de senhas ou códigos.
          ...
          >
            ...
            <div>
              ...
              <label
                ...
                className="block text-xs font-semibold text-[#543843] mb-1.5"
              >
                Seu Nome Completo
              </label>
            ...
            <div>
              ...
              <p className="text-[11px] text-[#8E6A77] mt-1 pl-1">
                ...
                Utilizado apenas para avisos e confirmações
                de seus horários.
      ...
      {/* =====================================================
          RODAPÉ
          IMPORTANTE:
          NÃO EXISTE MAIS BOTÃO DE ADMINISTRADOR AQUI.
      ====================================================== */}
